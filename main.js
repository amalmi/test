...
var tiling = new PIXI.projection.TilingSprite2d(new PIXI.Texture.fromImage("bkg.jpg"), app.screen.width, app.screen.height);
...
var bunny = new PIXI.projection.Sprite2d(PIXI.Texture.fromImage('flowerTop.png'));
